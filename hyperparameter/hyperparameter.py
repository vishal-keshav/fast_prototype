...
class HyperParameters:
    def __init__(self, version, project_path):
        ...
        file = Path(project_path + "/hyperparameter/version" + str(version) + \
                                                                  "/params.txt")
        if file.is_file():
            self.read_parameter()
        else:
    ...
    def dump_parameter(self):
        file_path = self.project_path + "/hyperparameter/version" + \
                                               str(self.version) + "/params.txt"
    ...
    def read_parameter_space(self):
        file_path = self.project_path + "/hyperparameter/version" + \
                                          str(self.version) + "/param_space.txt"
    ...
    def get_param_space(self):
        file = Path(self.project_path + "/hyperparameter/version" + \
                                         str(self.version) + "/param_space.txt")
        if file.is_file():
